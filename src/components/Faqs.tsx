...
const faqs = [
  ...
  {
    question: 'How does KEEP ensure that contracts are not lost or misplaced?',
    answer:
...
export function Faqs() {
  return (
    <section
      ...
      className="bg-[url('/images/background-faqs.webp')] bg-cover bg-center py-20 sm:py-32"
    >
      <Container className="relative">
        ...
        <ul className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8">
